...
<html>
    ...
    /* padding: px; */ 
    padding-block-start: 16px; /* Correct property name */
    padding-bottom: 17px;
    }
 ...
 if ($msg == "done") {
     echo "<div id='success-message' class='alert alert-success' role='alert'>Successfully Done</div>";
     echo "<script>setTimeout(function() { document.getElementById('success-message').style.display = 'none'; }, 1000);</script>";
 } elseif ($msg == "fail") {
 ...
 ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/openlibrarylogo.png"/></div>
    ...
    <div id="bookreport" class="innerright portion" style="display:none">
        ...
        $table = "<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style='padding: 8px;'>Book Name</th><th>Price</th><th>Qnt</th><th>Available</th><th>Rent</th></th><th>View</th><th>Delete</th></tr>";
        foreach ($recordset as $row) {
            $table .= "<tr>";
            "<td>$row[0]</td>";
            $table .= "<td>$row[2]</td>";
...
<div class="rightinnerdiv">
    <div id="addbook" class="innerright portion" style="<?php if (!empty($_REQUEST['viewid'])) { echo "display:none"; } else { echo ""; } ?>">
        <Button class="greenbtn">ADD NEW BOOK</Button><br><br>
        <form action="addbookserver_page.php" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" value="SUBMIT" style="background-color: rgb(0 123 255 / 50%);" /><br><br>
        </form>
    </div>
</div>
            ...
            <Button class="greenbtn" >ADD PERSON</Button><br><br>
            ...
            <tr>
                ...
                <th>Email</th>
                <th>Type</th>
                <th>Delete</th> <!-- Add this line for the new table head -->
            </tr>";
...
issue book -->
            ...
            <Button class="greenbtn" >ISSUE BOOK</Button><br><br>
...
<br>
            <label for="Select Student">Student</label>
...
<br>
           <label>Days</label> <input type="number" name="days"/><br>
...
<img width='150px' height='150px' style='border:1px solid #333333; float:left; margin-left:20px' src="uploads<?php echo $bookpic ?>" />
